...
import 't_internationall_model.dart';
export 't_internationall_model.dart';

class TInternationallWidget extends StatefulWidget {
  const TInternationallWidget({super.key});

  @override
  State<TInternationallWidget> createState() => _TInternationallWidgetState();
}

class _TInternationallWidgetState extends State<TInternationallWidget> {
  late TInternationallModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TInternationallModel());
