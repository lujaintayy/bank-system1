...
import 't_local_model.dart';
export 't_local_model.dart';

class TLocalWidget extends StatefulWidget {
  const TLocalWidget({super.key});

  @override
  State<TLocalWidget> createState() => _TLocalWidgetState();
}

class _TLocalWidgetState extends State<TLocalWidget> {
  late TLocalModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TLocalModel());
